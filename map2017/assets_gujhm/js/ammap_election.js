    ...
    d.AmDraw = d.Class({
        ...
        addDefs: function(a) {
            if (d.hasSVG) {
                ...
                a && (a.addCodeCredits && b.appendChild(document.createTextNode("Chart " + a.version)), c.appendChild(b), a.defs && (b = this.createSvgElement("defs"), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b))
            }
        }
    })
})();
                    ...
                    if (!isNaN(k)) {
                        ...
                        if (!isNaN(p)) {
                            var k = b.initialTouchZoom * t / p,
                                ...
                                l = (b.zoomY() - l * t) * (k / h) + l * t;.1 < Math.abs(k - h) && (b.zoomTo(k, p, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (f - c), e = a.y + (g - e), b.preventDragOut && (r = -r * k + m / 2, m /= 2, c = d.fitToBounds(c, -q * k + n / 2, n / 2), e = d.fitToBounds(e, r, m)), isNaN(c) || isNaN(e) || (a.translate(c, e, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = f;
                    b.previuosMouseY = g
                }
            }
