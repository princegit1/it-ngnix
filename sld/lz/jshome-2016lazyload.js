...
$(document).ready(function() {
    ...
    var s = 1;
    var frstdatasrc = $( ".anchores #listanchores .list-showing:eq("+0+")").find('img').attr('data-src');
    $( ".anchores #listanchores .list-showing:eq("+0+")").find('img').attr('src', frstdatasrc);
    $(".rigthnext-arrow-anchors").click(function() {        
       var st =  $( ".anchores #listanchores .list-showing:eq("+s+")");
       st.find('img').each(function(i, e) {
